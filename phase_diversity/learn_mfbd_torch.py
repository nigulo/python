...
class NN(nn.Module):
    ...
    def set_data(self, datasets, train_data=True):
        if train_data:
            self.Ds_train = Dataset(datasets, use_neighbours=use_neighbours)
        else:
            self.Ds_validation = Dataset(datasets, use_neighbours=use_neighbours)
    ...
    def do_test(self, dataset, file_prefix, true_coefs=None):
        ...
        Ds_test = Dataset([dataset], use_neighbours=use_neighbours)
