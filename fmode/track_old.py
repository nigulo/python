...
class track:
    ...
    def transform(self):
        ...
        if DEBUG:
            ...
            test_plot.colormap(data_nt, cmap="bwr", show_colorbar=True)
...
if (__name__ == '__main__'):
    ...
    tr = track(input_path=input_path, output_path=output_path, files=all_files, num_bursts=num_bursts, num_hrs=num_hrs, step=step, 
               num_patches=num_patches, patch_size=patch_size, start_times=start_times, commit_sha=commit_sha, random_start_time=True)
    tr.track()
