...
if os.path.exists('offset_tests/offset_exp.pkl'):
    ...
    while sum(counts) < max_count_per_bin * num_bins:
        ...
        freqs = np.linspace(0.5*f, 2.0*f, 1000)
...
line2, = ax_stats_1.plot(bin_locs, gls_err_means, 'bx', markerfacecolor='None', label = "GLS")
line3, = ax_stats_1.plot(bin_locs, ls_err_means, 'go', markerfacecolor='None', label = "LS")
