...
sig_var_orig = dat[indices, 7]
sig_var_gp_orig = dat[indices, 8]
trend_var_orig = dat[indices, 9]
trend_var_gp_orig = dat[indices, 10]

coh_lens = np.arange(0.5, 4.0, 0.1)
...
ax3.text(0.95, 0.9,'(c)', horizontalalignment='center', transform=ax3.transAxes)
...
fig.savefig("test/diagnostics1.pdf")
